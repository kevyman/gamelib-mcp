...
async def set_hardware_preference(platforms: list[str]) -> dict:
    ...
    Valid values: steam, epic, gog, switch2 (aka nintendo/switch), ps5, itchio, xbox, ea, ubisoft (aka uplay), other.
    """
...
async def add_game_to_platform(
    ...
    platform: steam | epic | gog | nintendo | switch2 | ps5 | itchio | xbox | ea | ubisoft | other
