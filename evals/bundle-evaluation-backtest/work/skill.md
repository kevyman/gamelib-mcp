...
A bundle is worth **what you'd pay for the games you actually want in it — nothing else**. Games they already own contribute €0. Filler they'll never launch contributes €0, whatever its Steam rating. The publisher's "€466 value!" MSRP-sum is price anchoring and never enters the math. The honest comparison is:
...
4. Sort every constituent into three want-tiers:
   - **Must-have** — they'd plausibly buy it on its own. Full assessment in Step 3.
...
If they buy it, the evaluation's constituent list becomes the acquisition record — same list, no re-derivation:
