...
async def _snapshot(
    ...
    """Write a snapshot with the last_played frozen onto it (as a sync would)."""
...
class RepairPlayHistoryCorrectionsTests(ToolDBTestCase):
    ...
    async def test_shape_of_real_growth_before_the_correction_is_preserved(self):
        ...
        await _snapshot(game_id, "ps5", "2026-06-30", 395, last_played="2026-06-04")
    ...
    async def test_growth_while_still_playing_is_left_alone(self):
        ...
        await _snapshot(game_id, "ps5", "2026-08-02", 200, last_played="2026-07-30")
    ...
    async def test_decrease_is_not_a_correction(self):
        ...
        await _snapshot(game_id, "ps5", "2026-07-04", 100, last_played="2022-01-01")
        await _snapshot(game_id, "ps5", "2026-08-02", 40, last_played="2022-01-01")
    ...
    async def test_platform_filter(self):
        ...
        await _snapshot(steam_game, "steam", "2026-07-04", 5, last_played="2021-01-01")
        await _snapshot(steam_game, "steam", "2026-08-02", 900, last_played="2021-01-01")
