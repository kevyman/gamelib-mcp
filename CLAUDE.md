...
- `games`: canonical game rows and shared enrichment fields; `igdb_platforms` (v19) is a JSON array of IGDB platform ids the game is released on, ownership-independent — Switch 2 is IGDB 508, Switch 130, both mapping to internal switch2
